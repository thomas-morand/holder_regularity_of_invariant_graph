...
function phi_n_per(phi ::phi, orb ::Vector{Float64}, len ::Int64, s ::Float64, n ::Int64, i ::Int64, err ::Float64) ::Interval{Float64}
...
function F_lower(phi ::phi, orbx ::Vector{Float64}, i ::Int64, n ::Int64, epsi ::Float64) ::Float64
...
function log_derivate_T_lower(T ::T, orb ::Vector{Float64}, epsi ::Float64) ::Float64
