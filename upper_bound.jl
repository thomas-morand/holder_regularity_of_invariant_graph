...
function split_interval(I ::Interval) ::Tuple{Interval,Interval}
...
function min_btw_phi_n_K(phi ::phi, T ::T, x ::Union{Float64,Interval{Float64}}, s ::Union{Float64,Interval{Float64}}, n ::Int64, K ::Float64) ::Union{Float64,Interval{Float64}}
...
function fct_for_upper_bound_lambda_f(inter ::Interval, T ::T, m ::Int64, K ::Float64, phi ::phi) ::Interval{Float64}
...
function fct_for_upper_bound_lambda_u(inter ::Interval, T ::T, m, K, phi) ::Interval{Float64}
    "This function is the one whose Birkhoff sum can be used to bound lambda_f."
