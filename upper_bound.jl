...
function fct_for_upper_bound_lambda_f(inter ::Union{Interval{Float64}, Interval{BigFloat}}, T ::T, m ::Int64, K ::Union{Float64, BigFloat}, phi ::phi) ::Union{Interval{Float64}, Interval{BigFloat}}
...
function fct_for_upper_bound_lambda_u(inter ::Union{Interval{Float64}, Interval{BigFloat}}, T ::T, m, K, phi) ::Union{Interval{Float64}, Interval{BigFloat}}
    "This function is the one whose Birkhoff sum can be used to bound lambda_f."
